...
@Component({
  ...
  templateUrl: './award-detail-evaluation.component.html',
  styleUrls: ['./award-detail-evaluation.component.scss']
})
export class AwardDetailEvaluationComponent implements OnInit {
